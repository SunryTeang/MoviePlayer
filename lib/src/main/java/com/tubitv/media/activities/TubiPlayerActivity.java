...
import com.tubitv.media.helpers.YouTubeHelper;
    ...
    protected MediaSource buildMediaSource(MediaModel model) {
        ...
        switch (type) {
            ...
            case C.TYPE_HLS: {
                ...
                if (model.getVideoUrl().toString().toUpperCase().contains("M3U8")) {
                    mediaSource = new HlsMediaSource(model.getVideoUrl(), mMediaDataSourceFactory, null,
                            mEventLogger);
                } else {
